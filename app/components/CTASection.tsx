...
export default function CTASection() {
 ...
 <Link
 to="/pricing"
 className="btn-ripple inline-flex items-center gap-2 px-8 py-3.5 rounded-lg bg-primary hover:bg-primary/90 text-primary-foreground font-semibold text-lg transition-all shadow-lg shadow-primary/25 hover:shadow-xl hover:-translate-y-0.5 cursor-pointer"
 >
