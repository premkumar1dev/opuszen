    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="min-h-screen md:ml-[220px]">
        ...
        <div className="sticky top-0 z-30 flex items-center gap-3 px-4 h-14 border-b border-border/60 bg-background/95 backdrop-blur md:hidden">
          ...
          <span className="text-sm font-semibold">Master Keys</span>
        </div>
                    ...
                    <div className="p-4 rounded-xl border border-border bg-muted/10">
                      <div className="flex flex-col gap-3">
                        ...
                        <div className="flex items-center justify-between border-t border-border/50 pt-3">
                          ...
                          <span
                            className={`inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-xs font-semibold ${keyDetails.isActive
                    ...
                    <div className="p-4 rounded-xl border border-border bg-muted/10">
                      ...
                      <div className="mb-2">
                        <div className="w-full bg-muted rounded-full h-2 dark:bg-muted/20 overflow-hidden">
                          <div
                            className={`h-full rounded-full transition-all duration-500 ${(detailsUsed / detailsLimit || 0) < 0.7
                                ? "bg-emerald-500"
